...
class _MyHomePageState extends State<HomePage> {
  ...
  //   String newsAPI = Endpoints.newsListUrl;
  //   var response = await http.get(Uri.parse(newsAPI));
  //
  //   if (kDebugMode) {
  //     print("we got in here ${jsonDecode(response.body)}");
  //   }
  //
  ...
  Widget outputScreen(List<NewsModel> newsList){
          ...
          child: BlocBuilder<NewsListBloc, NewsListState>(
            builder: (context, state) {
              ...
              return showProgressBar
                  ...
                  ? Status500Card(
                      onpressedRetry: () {
                        BlocProvider.of<NewsListBloc>(context).add(FetchNewsListEvent());
                      },
                      hideImage: true)
                  : isDataPresent
                  ? outputScreen(newsList!)
